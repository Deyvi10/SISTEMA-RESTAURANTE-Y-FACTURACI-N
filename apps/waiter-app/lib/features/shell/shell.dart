                    ...
                    if (avisos > 0)
                      Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            '$avisos',
                            style: const TextStyle(fontSize: 11, color: Color(0xFFFFFFFF), fontWeight: FontWeight.w700),
                          ),
                        ),
                      ),
                  ],
      ...
      child: CustomScrollView(
        slivers: [
          ...
          if (mesas.isEmpty)
            SliverFillRemaining(
              child: Center(
                child: Text('No tienes mesas abiertas.', style: RpText.body.copyWith(color: c.labelSecondary)),
              ),
            )
          else
            SliverToBoxAdapter(
            ...
            children: [
              ...
              if (s.error == null) ...[
                ...
                Text(
                  ...
                  style: RpText.body.copyWith(color: c.label),
                ),
                const SizedBox(height: RpSpace.s5),
