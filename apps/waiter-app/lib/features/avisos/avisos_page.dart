              ...
              children: [
                for (final a in avisos)
                  CupertinoListTile(
                    ...
                    trailing: CupertinoButton(padding: EdgeInsets.zero, onPressed: () => ref.read(avisosProvider.notifier).quitar(a.id), child: const Icon(CupertinoIcons.xmark_circle_fill)),
                  ),
              ],
            ),
          ),
